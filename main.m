...
int main(int argc, char *argv[])
{
    if(NSApplicationLoad()) {
        ...
        if([items count] == 1) {
            ...
            NSString * type = [[[NSFileManager defaultManager]
            ...
            if(!path) {
                ...
                // Try to find the frontmost Finder window and the path to its location.
            ...
            TerminalApplication * terminal = [SBApplication 
            ...
            // If System Events are enabled, send the Command K keystroke to the Terminal.
